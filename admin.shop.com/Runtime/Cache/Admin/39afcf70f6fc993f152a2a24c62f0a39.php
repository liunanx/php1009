    ...
    <div id="tabbody-div">
        <form action="<?php echo U();?>" method="post">
            <table width="90%" id="general-table" align="center">
                        ...
                        <td>
                            <input type='text' name='low' value='<?php echo ($low); ?>' size='30' />                        </td>
                    </tr>
                                    <tr>
                        <td class="label">最高积分</td>
                        <td>
                            <input type='text' name='high' value='<?php echo ($high); ?>' size='30' />                        </td>
                    </tr>
                                    <tr>
                        <td class="label">折扣</td>
                        <td>
                            <input type='text' name='discount' value='<?php echo ($discount); ?>' size='30' />                        </td>
                    </tr>
                                    <tr>
